...
export default function ResultCard({ data }: ResultCardProps) {
  ...
  return (
    <div className="w-full max-w-lg mx-auto p-4 mt-8">
      <div className="bg-zinc-900 border border-zinc-800 rounded-[2rem] overflow-hidden shadow-2xl flex flex-col">
        
        <div className="relative w-full h-[350px] overflow-hidden bg-zinc-950">
          <Image
            src={imageUrl}
            alt="Visual"
            fill
