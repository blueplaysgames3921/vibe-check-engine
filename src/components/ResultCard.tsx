  ...
  return (
    <div className="w-full max-w-md mx-auto p-4 mt-8">
      <div className="bg-zinc-900 border border-zinc-800 rounded-[2rem] overflow-hidden shadow-2xl">
        ...
        <div className="relative w-full h-[300px] bg-zinc-950">
          <Image
            src={imageUrl}
            alt="Visual"
            width={1080}
        ...
        <div className="p-6 bg-zinc-900">
          <div className="space-y-4">
            ...
            <button 
              ...
              className="w-full py-3 bg-zinc-100 hover:bg-white text-black font-bold rounded-xl transition-all active:scale-95"
            >
              Copy Script
            </button>
          </div>
